...
type
  TForm1 = class(TForm)
    ...
    procedure changeP1BtnClick(Sender: TObject);
    procedure changeP2BtnClick(Sender: TObject);
  private
...
// 更改玩家1圖片
procedure TForm1.changeP1BtnClick(Sender: TObject);
begin
  if openDlg.Execute then
  begin
    p1Img := openDlg.FileName;
    imgP1.Picture.LoadFromFile(p1Img);
  end;
end;

// 更改玩家2圖片
procedure TForm1.changeP2BtnClick(Sender: TObject);
begin
  if openDlg.Execute then
  begin
    p2Img := openDlg.FileName;
    imgP2.Picture.LoadFromFile(p2Img);
  end;
end;
